import { QnetType, ExamSchedules } from '../../apis/crawling/types/qnet.type';
...
export interface createQNet {
    ...
    categoryObj: Pick<QnetType, 'mainCategory' | 'subCategory'>;
}
...
export type findeCrawlingType = paths & { id: string };
